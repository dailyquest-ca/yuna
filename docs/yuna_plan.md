...
- 2026-09-14 — §4.3's "amber/red pipeline: no new buy tickets" is read through §4.4 and the freshness rule: a **red** check holds buys; an **amber** from a price-critical job (`ingest-daily`, `score`) holds buys; any other amber, the check suite's own gauges included, warns and holds nothing.
